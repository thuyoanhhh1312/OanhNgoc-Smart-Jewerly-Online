        ...
        },
        {
            ...
            tooltip: (
                <>
                    ...
                    <br />
                    Tính từ lúc cửa hàng xuất hóa đơn (nhận tại cửa hàng) hoặc khi khách hàng nhận được sản phẩm (giao hàng tận nơi).
                </>
            ),
        },
    ];
    ...
    return (
        <MainLayout>
            ...
            <div className="max-w-[1500px] mx-auto p-4 md:p-8">
                ...
                {/* Sản phẩm tương tự */}
                <section className="max-w-[1400px] mx-auto px-4 md:px-8 2xl:px-0 mt-12">
                        ...
                        {similarProducts.length > 0 ? (
                            similarProducts.map((item) => (
                                <Link
                                    ...
                                    className="flex-shrink-0 w-[280px] bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden cursor-pointer"
                                >
                                    <img
                                        src={
                            ...
                            <p className="text-center w-full">Không có sản phẩm tương tự</p>
                        )}
                    </div>
                </section>
